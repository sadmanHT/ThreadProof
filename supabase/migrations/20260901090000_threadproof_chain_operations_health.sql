...
-- Keep the worker-only diagnostic column private. Authenticated callers receive only
-- the fields required to compare the projected cursor against the live RPC head.
grant select (
  chain_id,
  last_block_number,
  last_block_hash,
