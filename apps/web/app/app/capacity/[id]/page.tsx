...
export default async function CapacityDetailPage({ params }: Props) {
  ...
  return (
    <div className="workspace-page">
      ...
      <section className="panel trust-panel"><span className="kicker">AUTHORITY BOUNDARY</span><h2>CapacityVault decides which commitment and allocation are canonical.</h2><p>Supabase stores encrypted witness material and rebuildable reconciliation records so workers and operators can coordinate. Allocation identifiers shown here are copied only from matching CapacityAllocationRecorded events; they are never manufactured from application input. Stale application state cannot authorize a second spend, and this page must never be treated as the canonical capacity ledger.</p></section>
    </div>
  );
}
