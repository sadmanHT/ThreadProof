...
export default async function OrderDetailPage({ params, searchParams }: Props) {
  ...
  const [{ data: versions }, { data: orgs }, { data: authorizationJobs }] = await Promise.all([
  ...
  const canAuthorize = canOperate && !!order.factory_organization_id && ["draft", "proposed", "feasible", "infeasible"].includes(order.status);
