...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      subcontract_authorization_jobs: Table<{
        buyer_organization_id: string;
        ...
        compliance_credential_id: string;
        confirmed_at: string | null;
        created_at: string;
        created_by: string;
        deadline: string;
        ...
        parent_factory_organization_id: string;
        parent_factory_signature: string | null;
        parent_order_id: string;
        parent_version: number;
        parent_version_hash: string;
        period_id: string;
        policy_hash: string;
        process_credential_id: string;
        process_id: string;
        sequence: number;
        status: string;
